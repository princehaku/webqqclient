...
public class TestLogin {
    ...
    public static void main(String argv[]) throws Exception {
        ...
        se.eval(new FileReader("src/common.js"));
        ...
        // uin获取
        hc.setUrl("http://check.ptlogin2.qq.com/check?uin=" + qnumber + "&appid=1003903&r=" + Math.random());
        content = hc.exec();
        String vc = se.eval(new String(content)).toString();
        //下载图片
        ...
        String p = (String) (in.invokeFunction("encrypt", vc, qpasswd, verCode));
